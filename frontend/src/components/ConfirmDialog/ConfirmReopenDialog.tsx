  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 p-4">
      <div className="w-full max-w-sm rounded-xl bg-white p-5 shadow-xl ring-1 ring-slate-200">
        <h3 className="text-sm font-semibold text-slate-800">Reopen ticket?</h3>
        <p className="mt-2 text-sm text-slate-500">
          <span className="font-mono text-xs text-slate-400">{ticket.id}</span> is currently closed. Do you want to
          reopen it?
        </p>
